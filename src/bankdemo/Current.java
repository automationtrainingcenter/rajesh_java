...
public class Current extends BaseAccount {
	private static final double minBalance = 20000;
	private static final double fee = 500;

	public Current(int id, String name, String address, String phoneNum, double balance, long aadharNum) {
		super(id, name, address, phoneNum, balance, aadharNum);
	}

	public Current(int id, String name, String address, String phoneNum, double balance, String panNum) {
