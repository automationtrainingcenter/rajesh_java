...
public class Account {
	...
	private Account(int id, String name, String address, String phoneNum, double balance) {
		this.id = id;
		this.name = name;
	...
	public Account(int id, String name, String address, String phoneNum, double balance, String panNum) {
		this(id, name, address, phoneNum, balance);
		this.panNum = panNum;
	}

	public Account(int id, String name, String address, String phoneNum, double balance, long aadharNum) {
		this(id, name, address, phoneNum, balance);
