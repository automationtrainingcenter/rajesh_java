...
public class VariablesDemo {
	...
	public static void main(String[] args) {
		// local variable
		int lVar = 30;
		System.out.println("local varible lvar = "+lVar);

		// accessing instance variable by creating an object
		...
		// accessing static variable 
		VariablesDemo.sVar = 20;
		System.out.println("static varaible sVar = "+VariablesDemo.sVar);
